 ...
 *
 * Overlay: real source (packages/llm/llm/src/message.ts) type-stripped
 * (erasable-only). `MessageId` / `CallId` / `deepFreeze` are the value
 * imports the fusion graph needs; everything else here is type-only and
 * stripped.
 *
 * @module @deepseek-ai/dsh-llm/message
 */
