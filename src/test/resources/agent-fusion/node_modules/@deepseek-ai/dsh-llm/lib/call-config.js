 ...
 *
 * Overlay: real source (packages/llm/llm/src/call-config.ts) type-stripped
 * (erasable-only). The `GenerateOptions` / `ReasoningEffortId` imports are
...
/**
 * Field-wise equality over a call config — the comparison a caller runs to
