 ...
 *
 * Overlay: real source (packages/core/scope/src/index.ts) type-stripped
 * (erasable-only). Type-only imports are stripped; the value import
 * `{ Context }` resolves to the @deepseek-ai/cordis shim, which exposes the
 * `filter` symbol this module keys its scope carrier on.
 *
