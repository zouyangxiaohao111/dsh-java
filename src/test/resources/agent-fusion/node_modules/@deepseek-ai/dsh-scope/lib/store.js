 ...
 *
 * Overlay: real source (packages/core/scope/src/store.ts) type-stripped
 * (erasable-only). `Context` is type-only and stripped; `scopeChainOf` /
 * `scopeOf` resolve through the (circular, live-binding) import of ./index.js.
 *
