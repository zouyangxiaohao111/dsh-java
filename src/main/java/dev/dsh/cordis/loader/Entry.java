 ...
 * <p>三个定位字段:
 * <ul>
 *   <li>{@code source} — 扩展写法,可带 {@code java:}/{@code node:}/{@code graaljs:} 前缀
 *       (如 {@code java:dev.dsh.demo.CounterPlugin}、{@code graaljs:./plugins/greeter});</li>
 ...
 * </ul>
 */
public record Entry(String name, String source, String path, HostKind host) {
    ...
    public static Entry parse(JsonNode node) {
        ...
        return new Entry(name.trim(), source, path, host);
    }
