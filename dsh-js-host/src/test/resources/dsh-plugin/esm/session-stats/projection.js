 ...
 * and wall times.
 *
 * ESM form of the real @deepseek-ai/dsh-session-stats projection (type-stripped
 * only; no CJS transform). GraalJS standalone needs the hand-written CJS shims
 * + a require() transform; the Node worker loads this file natively.
 *
