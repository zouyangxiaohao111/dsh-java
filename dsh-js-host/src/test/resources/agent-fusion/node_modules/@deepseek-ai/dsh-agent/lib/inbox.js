 ...
 *
 * Overlay: real source (packages/core/agent/src/inbox.ts) type-stripped.
 * `@deepseek-ai/dsh-llm` / `@deepseek-ai/dsh-session` are type-only and
 * stripped; the Inbox class itself is pure projection logic over the session
 * object handed to it.
 *
