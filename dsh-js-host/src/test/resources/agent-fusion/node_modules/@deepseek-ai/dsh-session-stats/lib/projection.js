 ...
 * is the step lifecycle authority.
 *
 * Overlay: real source (packages/session/session-stats/src/projection.ts)
 * type-stripped (erasable-only). `zod` and `@deepseek-ai/dsh-llm/message` are
 * the value imports; `ProjectionDefinition` is type-only and stripped.
 *
